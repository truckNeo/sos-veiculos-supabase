-- Máquina de estados operacional do chamado. As transições financeiras
-- continuam nas RPCs de cobrança; esta função cobre deslocamento, chegada e
-- cancelamento, sempre registrando um evento de auditoria.
...
revoke all on function public.transition_service_request_status(uuid, public.service_request_status, text) from public;
grant execute on function public.transition_service_request_status(uuid, public.service_request_status, text) to authenticated;
