begin;
alter table public.app_notifications add column push_sent_at timestamptz,
...
language sql security definer set search_path = public as $$
  update public.app_notifications n set push_attempts = n.push_attempts + 1,
    push_lease_until = now() + interval '10 minutes', push_claim = gen_random_uuid()
  where n.id in (select id from public.app_notifications
