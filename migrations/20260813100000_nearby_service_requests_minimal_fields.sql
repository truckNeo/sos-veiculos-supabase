-- Reduz a exposição da descoberta aos dados exibidos ao prestador antes da proposta.
-- A ordenação e a expiração continuam usando opened_at internamente.

drop function if exists public.get_nearby_service_requests(integer, integer, integer);

create function public.get_nearby_service_requests(
